 ...
 * specific period of time. The <tt>Timer</tt> class emulates a hardware timer by scheduling a timer
 * interrupt to occur every time approximately 500 clock ticks pass. There is a small degree of
 * randomness here, so interrupts do not occur exactly every 500 ticks.
 */
public final class Timer {
    ...
    private void scheduleInterrupt() {
        ...
        delay += Lib.random(delay / 10) - (delay / 20);//输出4
