...
//import nachos.verify.TestCondition;
import nachos.userprog.UserProcess;
import nachos.verify.*;
...
public class ThreadedKernel extends Kernel {
     ...
     * tests here.
     */
    public void selfTest() {//内核自检  可以填写代码
...
//        TestPriorityScheduler.TestPriorityScheduler();
//        TestPriorityScheduler.TestJoin();
//        Boat.selfTest();

        //Task 2

//        TestLotteryScheduler.TestLotteryScheduler();
//        UserProcess.setDebug(true);
//        UserProcess.setDebug2(true);
